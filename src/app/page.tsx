            ...
            <div className="flex flex-wrap justify-center gap-5 mb-20">
              ...
              <div className="relative pr-2 pb-2">
                <Link href="/ai-style" className="relative group overflow-visible flex items-center space-x-3 bg-gradient-to-br from-primary-800/95 via-primary-800/95 to-primary-800/95 backdrop-blur-xl border-2 border-accent-400/80 hover:border-accent-300 px-8 py-4 rounded-2xl transition-all duration-300 shadow-2xl shadow-black/40 hover:shadow-3xl hover:shadow-accent-400/60 hover:scale-105 active:scale-95">
                  ...
                  <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/60 via-blue-500/60 to-indigo-500/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl blur-sm -z-10"></div>
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/40 via-blue-400/40 to-indigo-400/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
                  ...
                  <span className="font-bold text-lg text-white relative z-10 group-hover:text-cyan-200 transition-colors">AI Style Match</span>
                </Link>
              </div>
