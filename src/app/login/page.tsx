      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="button"
              onClick={() => alert('🚧 Google Sign-In Coming Soon!\n\nFor now, please use email/password to sign in.\n\nGoogle OAuth will be enabled in a future update.')}
              className="w-full flex items-center justify-center px-4 py-3 border border-primary-600 rounded-lg bg-white hover:bg-gray-100 text-gray-900 transition-colors font-medium"
            >
